import { InventoryType, EntityActionType, ItemActionType, ItemConditionType, ItemSlot, ArrayOfItemSlots, Identifier, ItemStack } from "../Types";
import BaseEntityAction from "./BaseEntityAction";

export default class ReplaceInventoryAction extends BaseEntityAction {
    ...
    constructor() {
        super()
        this.type = "origins:replace_inventory";
    }
