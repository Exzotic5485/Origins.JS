...
export default class ActionOnCallbackPower extends BasePower {
    public entity_action_chosen?: EntityActionType;
    public execute_chosen_when_orb: boolean = true;
    public entity_action_gained?: EntityActionType;
    public entity_action_lost?: EntityActionType;
    public entity_action_added?: EntityActionType;
    public entity_action_removed?: EntityActionType;
